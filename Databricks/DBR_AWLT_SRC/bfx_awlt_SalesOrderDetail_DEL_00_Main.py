...
dbutils.notebook.run("./bfx_awlt_SalesOrderDetail_DEL_01_Full", 0, {"row_audit_id": row_audit_id, "location_path": location_path, "_bfx-stg": _bfx-stg, "_bfx-ods": _bfx-ods})